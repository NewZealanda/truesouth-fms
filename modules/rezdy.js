...
window.rezdyLoadPickups=async function(){
  ...
  if(row&&Array.isArray(row.vans)){
    ...
    S._pickupVans=null;S._pickupCollected={};S._pickupLocOverride={};S._pickupDrivers=[];S._pickupExtraDrivers=[];S._rezdyPaxMeta={};
  }
...
window.pickupSave=async function(silent){
  const payload={
    ...
    data:{vans:S._pickupVans||[],collected:S._pickupCollected||{},locOverride:S._pickupLocOverride||{},drivers:S._pickupDrivers||[],extraDrivers:S._pickupExtraDrivers||[],paxMeta:S._rezdyPaxMeta||{}}
  };
