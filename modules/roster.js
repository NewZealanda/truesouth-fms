...
function renderRosterView(){
  ...
  h+='<th style="padding:8px '+(S.mobileView?'6px':'12px')+';text-align:left;font-size:11px;font-weight:700;color:var(--text3);min-width:'+(S.mobileView?'46px':'155px')+';position:sticky;left:0;z-index:21;background:var(--card2);border-right:1px solid var(--border)">Crew</th>';
