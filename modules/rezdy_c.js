...
// the Caravans. Returns the seat index or null if this aircraft has no such pax seat.
var _RZ_EXIT_IDX=13;
function _rzExitSeat(acId){var a=(typeof _acSpec==='function')?_acSpec(acId):S.aircraft[acId];if(!a||!a.seats||!a.seats[_RZ_EXIT_IDX])return null;if((a.removedSeats||[]).indexOf(_RZ_EXIT_IDX)>=0)return null;return _RZ_EXIT_IDX;}
