...
function _bizState(){
  ...
  // Seed historical pax from the spreadsheet when there's none (covers a saved blob with an empty {}).
  if(!S._bizPlan.paxData||typeof S._bizPlan.paxData!=='object'||!Object.keys(S._bizPlan.paxData).length)S._bizPlan.paxData=(typeof _bizPaxDefault==='function')?_bizPaxDefault():{};
