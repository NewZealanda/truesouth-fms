...
function _bizRunCalcView(){
  ...
  if(ac){
    ...
    var row=function(lbl,val,strong){return '<div style="display:flex;justify-content:space-between;gap:12px;padding:5px 0;border-top:1px solid var(--border2)'+(strong?';font-weight:800':'')+'"><span style="color:'+(strong?'var(--text1)':'var(--text2)')+'">'+lbl+'</span><span style="'+(strong?'font-size:17px;color:#f59e0b':'color:var(--text1)')+'">'+_bizPh(val)+'</span></div>';};
