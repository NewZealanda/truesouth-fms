...
function _renderApprovals(lv,role){
  ...
  filtered.forEach(function(r){
    ...
    // Conflicts — show everyone else off during this period (approved + pending)
    if(overlaps.length>0){
      ...
      h+='<div style="font-size:12px;font-weight:700;color:#fbbf24;margin-bottom:6px">⚠ '+overlaps.length+' conflict'+(overlaps.length!==1?'s':'')+' — others off during this period</div>';
