...
var _TRAIN_TIPS=[
  ...
  {icon:'🌤️',title:'Weather calls',body:'The Weather calls page (top of the menu) lists every departure for the day. Any pilot can record a call — Called ON (green), Cancelled (red, with reason + next best day) or a Final call in the office (amber) — each with a comment. If no call is made, the PIC gets a reminder 15 min before the 1-hour-prior deadline, and the Today page shows each flight\'s status at a glance.'},
