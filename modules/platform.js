...
var _PROD_FIELDS={name:'s',dest_short:'s',price_adult:'n',price_child:'n',price_infant:'n',duration_min:'i',sort:'i',description:'s'};
...
function renderAdminProducts(){
  ...
  var h='<div class="card"><div class="st" style="margin-bottom:6px">Products &amp; Pricing</div>'+
    ...
    '<b>Public ✓</b> = offered on the direct booking page. Fuel/burn stays in the ⛽ Fuels tab. Requires <code>products.sql</code> applied in Supabase.</p>';
  if(!list.length){
    ...
    h+='<div style="overflow-x:auto"><table style="width:100%;border-collapse:collapse;font-size:12px;min-width:920px">'+
    ...
    list.forEach(function(p){
      ...
      h+='<tr><td></td><td colspan="10" style="padding:0 6px 6px"><input id="pr_'+cj+'_ds" type="text" value="'+esc(p.description||'')+'" placeholder="Short public description (optional)" onchange="window.platformProdSet(\''+cj+'\',\'description\',this.value)" style="'+ist+';width:100%;font-size:11px;color:var(--text2)"></td></tr>';
    });
    h+='</table></div>';
  }
  var d=S._prodDraft||{};
