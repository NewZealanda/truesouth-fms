...
// Hidden shortcut: tap anywhere 4× in quick succession (each tap ≤500ms after the last) → jump
// straight to the Flight Record. A pilot convenience for logging on the apron without digging
// through the menu. Capture phase so it counts taps even on buttons; only fires for users who can
// actually see the Flight Record.
(function(){
